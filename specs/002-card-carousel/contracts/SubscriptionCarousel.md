...
```typescript
export function SubscriptionCarousel(props: SubscriptionCarouselProps): JSX.Element
...
**Internal State**:
```typescript
const [billingCycle, setBillingCycle] = useState<BillingCycle>(initialBillingCycle || 'month')
